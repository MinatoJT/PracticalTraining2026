...
class QwenVisionProvider:
    ...
    def verify_answer(
        ...
        prompt = (
            ...
            "must include all major supported items. For genre, category, or taxonomy lists, use the shortest complete set "
            "of principal categories explicitly supported by evidence and remove adjacent subgenres, themes, demographic "
            "labels, or plausible-but-unverified classifications. A side-effect or consequence question needs the requested specifics, "
